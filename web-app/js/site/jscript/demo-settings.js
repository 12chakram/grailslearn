...
jQuery(document).ready(function() {
	...
	jQuery(".demo-settings").append("<div class='demo-options'>"+
										...
										"<a href='#demo' rel='font-options' class='option'><img src='images/site/demo/image-1.png' class='demo-icon' alt='' /><span>Font Settings</span><font>Change Fonts</font></a>"+
										"<div class='option-box' rel='font-options'>"+
											...
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='color-options' class='option'><img src='images/site/demo/image-2.png' class='demo-icon' alt='' /><span>Color Options</span><font>Color schemes</font></a>"+
										...
										"<div class='option-box sequal' rel='color-options'>"+
											...
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='page-header' class='option'><img src='images/site/demo/image-6.png' class='demo-icon' alt='' /><span>Change Header</span><font>Choose Header Style</font></a>"+
										"<div class='option-box' rel='page-header'>"+
											"<div alt='header-box'>"+
												"<b class='sub-title'>Header Style</b>"+
												"<a href='#' class='header-bulb active' rel='style-2'><img src='images/site/demo/header-2.png' alt='' /></a>"+
												"<a href='#' class='header-bulb' rel='style-1'><img src='images/site/demo/header-1.png' alt='' /></a>"+
											"</div>"+
										"</div>"+
										"<div class='option-box sequal' rel='page-header'>"+
											...
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='background' class='option'><img src='images/site/demo/image-3.png' class='demo-icon' alt='' /><span>Background</span><font>Backgorund textures</font></a>"+
										"<div class='option-box' rel='background'>"+
											"<div alt='background'>"+
												...
												"<a href='#' class='color-bulb' style='background: url(images/site/background-texture-3.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url(images/site/background-texture-1.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url(images/site/background-texture-2.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url(images/site/background-texture-4.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background: url(images/site/background-texture-5.jpg);'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url(images/site/background-photo-1.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url(images/site/background-photo-2.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url(images/site/background-photo-3.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
												"<a href='#' class='color-bulb' style='background-image: url(images/site/background-photo-4.jpg);background-size: 100%; background-attachment: fixed;'>&nbsp;</a>"+
											"</div>"+
										"</div>"+
										"<a href='#demo' rel='page-width' class='option'><img src='images/site/demo/image-4.png' class='demo-icon' alt='' /><span>Change Width</span><font>Boxed or Full-Width</font></a>"+
