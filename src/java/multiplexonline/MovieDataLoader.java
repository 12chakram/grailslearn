...
//		extractActresses();
		...
		//extractMovieData();
		FileOutputStream fos = new FileOutputStream(new File("/home/kumar/multiplexonline_resource/MovieDetails.list"));
	...
	public static ArrayList<MovieData> loadMovieData(String fileName) throws Exception {
		...
		File file = new File("/home/kumar/multiplexonline_resource/MovieDetails.list");
