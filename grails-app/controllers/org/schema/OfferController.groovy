...
class OfferController {
    ...
    def save(Offer offerInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'offerInstance.label', default: 'Offer'), offerInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'offerInstance.label', default: 'Offer'), params.id])
                redirect action: "index", method: "GET"
            }
