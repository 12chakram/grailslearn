...
<html>
	...
	<body>
		...
		<div id="edit-creativeWork" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${creativeWorkInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${creativeWorkInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:creativeWorkInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${creativeWorkInstance?.version}" />
				<fieldset class="form">
