...
<body> 
            <section class="scrollable padder">
              ...
              <div class="m-b-md">
              <sec:ifLoggedIn>
                <small>Welcome back, <sec:username/></small>
              </sec:ifLoggedIn>
              </div>
              <section class="panel panel-default">
                <div class="row m-l-none m-r-none bg-light lter">
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong>${existingUser}</strong></span>
                      <small class="text-muted text-uc">Existing users</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                      ...
                      <!-- 
	                      ...
	                      data-scale-Color="false" data-size="50" data-line-cap='butt' data-animate="2000" data-target="#bugs" 
	                      data-update="3000"></span>
                    --> 
                     </span>
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="bugs">${publishAdmins}</strong></span>
                      <small class="text-muted text-uc">Publishers</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">                     
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                      ...
                      data-scale-Color="false" data-size="50" data-line-cap='butt' data-animate="3000" data-target="#firers" 
                      data-update="5000"></span>
                    --> 
                     </span>
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="firers">${publishUsers}</strong></span>
                      <small class="text-muted text-uc">Publisher users</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong>${endusers}</strong></span>
                      <small class="text-muted text-uc">End users</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">                     
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="firers">${siteUsers}</strong></span>
                      <small class="text-muted text-uc">Site users</small>
                    </a>
                  </div>
                </div>
              </section>
