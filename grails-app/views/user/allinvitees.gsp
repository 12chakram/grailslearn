                   ...
                   <g:each in="${allInvitedUsers}">
                    <div class="col-sm-3">
                       <section class="panel panel-default">
                        <header class="${it.role == 'ROLE_PUBLISHER_ADMIN' ? 'bg-danger':'bg-info'} panel-heading lt no-border">
                         <% it.role = it.role.replace("ROLE","").replaceAll("_"," ") %>
                          <div class="clearfix">
                            ...
                            <div class="clear">
                              ...
                              <small class="text-muted">${it.role}</small>
                            </div>                
                          </div>
                        </header>
