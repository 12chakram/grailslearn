...
%>
	...
	<table>
		...
		<tr>
			...
			<g:sortableColumn property="fullName" title="${message(code: 'user.fullName.label', default: 'FullName')}" params="${queryParams}"/>
			<g:sortableColumn property="email" title="${message(code: 'user.email.label', default: 'Email')}" params="${queryParams}"/>
			<g:sortableColumn property="mobile" title="${message(code: 'user.mobile.label', default: 'Mobile')}" params="${queryParams}"/>
			<g:sortableColumn property="gender" title="${message(code: 'user.gender.label', default: 'Gender')}" params="${queryParams}"/>
			<g:sortableColumn property="dob" title="${message(code: 'user.dob.label', default: 'Dob')}" params="${queryParams}"/>
			<g:sortableColumn property="fbid" title="${message(code: 'user.fbid.label', default: 'Fbid')}" params="${queryParams}"/>
		...
		<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
			...
			<td>${user.fullName}</td>
				<td>${user.email}</td>
					<td>${user.mobile}</td>
						<td>${user.gender}</td>
							<td><g:formatDate date="${user.dob}" format="yyyy-MM-dd" /></td>
