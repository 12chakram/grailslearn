                  ...
                  <section class="panel panel-default">
                    ...
                    <section class="chat-list panel-body">
                      <article id="chat-id-1" class="chat-item left">
                        <a href="#" class="pull-left thumb-sm avatar"><g:img uri="/images/avatar.jpg" class="img-circle"/></a>
                      ...
                      <article id="chat-id-1" class="chat-item right">
                        <a href="#" class="pull-right thumb-sm avatar"><g:img uri="/images/avatar_default.jpg" class="img-circle"/></a>
                        <section class="chat-body">                      
                    ...
                    <footer class="panel-footer">
                      ...
                      <article class="chat-item" id="chat-form">
                        <a class="pull-left thumb-sm avatar"><g:img uri="/images/avatar.jpg" class="img-circle"/></a>
                        <section class="chat-body">
