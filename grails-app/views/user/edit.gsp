	...
	<s2ui:tab name='userinfo' height='275'>
		...
		<tbody>
			...
			<s2ui:textFieldRow name='username' labelCode='user.username.label' bean="${user}"
             ...
             <s2ui:textFieldRow name='fullName' labelCode='user.fullName.label' bean="${user}"
                            labelCodeDefault='FullName' value="${user?.fullName}"/>
            ...
            <s2ui:textFieldRow name='email' labelCode='user.email.label' bean="${user}"
               ...
               <s2ui:textFieldRow name='gender' labelCode='user.mobile.label' bean="${user}"
                            labelCodeDefault='Gender' value="${user?.gender}"/>
                            
               <s2ui:textFieldRow name='dob' labelCode='user.dob.label' bean="${user}"
                            labelCodeDefault='Dob' value="${user?.dob}"/>
               
               <s2ui:textFieldRow name='fbid' labelCode='user.fbid.label' bean="${user}"
                            labelCodeDefault='Fbid' value="${user?.fbid}"/>
