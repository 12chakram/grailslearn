...
<html>
	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
			 <g:if test="${role?.toString().equals('user')}">
				<li><a class="home" href="${createLink(action:'getUsers',controller:'home')}"><g:message code="Users"/></a></li>
				<li><g:link controller="user" action="logout" style="margin-left:94.3%;">Logout</g:link></li>
		   </g:if>
			 <g:if test="${role?.toString().equals('admin')}">
