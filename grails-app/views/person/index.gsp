		...
		<div id="list-person" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="sanitizedName" title="${message(code: 'person.sanitizedName.label', default: 'Sanitized Name')}" />
					
						<g:sortableColumn property="imdbName" title="${message(code: 'person.imdbName.label', default: 'Imdb Name')}" />
				...
				<g:each in="${personInstanceList}" status="i" var="personInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: personInstance, field: "sanitizedName")}</td>
					
						<td>${fieldValue(bean: personInstance, field: "imdbName")}</td>
