		...
		<g:form >
				<fieldset class="form">
					...
					<div class="fieldcontain">
						...
						<g:select name="mediaSelect" from="${SOMovieInstance?.songs}" optionKey="id" optionValue="name"  value="${mediaInstanace}"/>
						</g:if>
						<g:if test="${videoType == 'Movie Clip'}">
						<g:select name="mediaSelect" from="${SOMovieInstance?.movieClips}" optionKey="id" optionValue="name"  value="${mediaInstanace}"/>
						</g:if>
						<g:if test="${videoType == 'Movie Promotion'}">
						<g:select name="mediaSelect" from="${SOMovieInstance?.moviePromotions}" optionKey="id" optionValue="name"  value="${mediaInstanace}"/>
						</g:if>
					</div>
					<g:if test="${videoType == 'Song'}">
