			...
			<div class="row">
				<div class="col-lg-4 col-lg-offset-4 m-t-large">
					<section class="panel panel-default bg-white m-t-lg">
						...
						<g:form action="register" controller="signup" method='POST'
							id='loginForm' class="panel-body wrapper-lg" autocomplete='off'
							data-validate="parsley">
							<g:hiddenField name="roles" value="${command?.roles}" />
							<div class="form-group">
								<label class="control-label">User Name</label> <input
									type="text" name="username" value="${command?.username}"
									class="form-control" placeholder="eg. Your name or company"
									data-required="true" />
							</div>
							<div class="form-group">
								<label class="control-label">Your email address</label> <input
									type="email" name="email" value="${command?.email}"
							...
							<div class="form-group pull-in clearfix">
								<div class="col-sm-6">
									<label class="control-label">Enter password</label> <input
										...
										value="${command?.password}" class="form-control"
										type="password" data-required="true">
								</div>
								<div class="col-sm-6">
									<label class="control-label">Confirm password</label> <input
										id="inputPassword2" name="password2" placeholder="Password"
										value="${command?.password2}" class="form-control"
										type="password" data-required="true">
								</div>
							</div>
							<div class="form-group pull-in clearfix">
								<div class="col-sm-6">
									...
									<g:textField name="mobile" value="${command?.mobile}"
										class="form-control" placeholder="Eg:+91999999999"
										data-required="true" />
								</div>
								<div class="col-sm-6">
									<label class="control-label">Date of Birth</label>
									<calendar:datePicker name="dob" id="dob"
										value="${command?.dob}" oSelection="['':'-Choose-']"
							...
							<div class="form-group pull-in clearfix">
								<div class="col-sm-6">
									...
									<g:textField name="captcha" placeholder="Password"
							...
							<div class="form-group">
								<label class="col-sm-2 control-label"
									style="margin-left: -19px; margin-top: 2px; text-align: center;">Gender</label>
								<div class="col-sm-12" style="margin-top: 10px;">
									<!-- radio -->
									<label class="radio-custom"> <input type="radio"
										name="gender" value="male"> Male
									</label> <label class="radio-custom"> <input type="radio"
										name="gender" value="female"> Female
									</label> <label class="radio-custom"> <input type="radio"
										name="gender" checked="checked" value="notspec"> Not
										to specify
									</label>
								</div>
							</div>
							<div class="checkbox">
								<label style="margin-left: 4px;"> <g:checkBox name="toc"
										checked="checked" value="${command?.toc}"
										id="signup_TermsOfService" class="checkbox"
										data-required="true" />Agree the <a href="#">terms and
										policy</a>
								</label>
							</div>
							...
							<div class="row">
								<div class="col-sm-6 text-center">
									<i class=""> <fb:login-button scope="email,publish_stream"
											onlogin="facebookLogin();" size="large" style="height:30px;">
