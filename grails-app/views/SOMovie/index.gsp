...
<g:set var="entityName"
	value="${message(code: 'SOMovie.label', default: 'SOMovie')}" />
		...
		<section class="vbox">
			<section class="scrollable padder">
				<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
					...
					<li class="active"><i
						class="iconicfill-movie text-success text"></i> Movies</a></li>
					<li><a href="${createLink(uri: '/SOMovie/create')}"><i
							class="fa fa-edit text"></i> Create</a></li>
				</ul>
						...
						<table class="table table-striped b-t b-light">
							...
							<tbody>
								<g:each in="${SOMovieInstanceList}" status="i" var="SOMovieInstance">
									<tr>
										<td><g:link controller="${SOMovieInstance.controllerName}"
												action="edit" id="${SOMovieInstance.id}">
												<i class="fa fa-edit text"></i>
											</g:link></td>
										<td><g:link controller="${SOMovieInstance.controllerName}"
												action="show" id="${SOMovieInstance.id}">
												${fieldValue(bean: SOMovieInstance, field: "name")}
											</g:link></td>
										<td>
											<g:formatNumber number="${SOMovieInstance?.releaseYear}" format="####" />
										</td>
										<td>
											${fieldValue(bean: SOMovieInstance, field: "inLanguage")}
										</td>
										<td>
											${fieldValue(bean: SOMovieInstance, field: "timeRequiredText")}
										</td>
